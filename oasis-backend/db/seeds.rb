...
rp8 = RooftopPark.create({
    ...
    state: "Washington",
    zipcode: 98101,
    description: "The location in downtown Seattle, close to Pike Place Market, gives you one of the best views in town. The Nest rooftop bar offers breathtaking views over Elliott Bay, downtown and the Olympic Mountain Range, which makes it one of few rooftop bars in Seattle with both city and nature views. Very stylish and trendy in decoration, the beautiful lounge and terrace comes with comfy sofas, fire-pits and quite a lot of greenery. The rooftop bar serves fantastic hand-crafted cocktails, fine wines, beers along with a smaller selection of tasty bar bites.",
